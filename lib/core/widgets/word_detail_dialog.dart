...
import '../../features/dictionary/models/dictionary_word_model.dart';
  ...
  Widget _buildContentBody(bool isDark) {
    ...
    return Column(
      ...
      children: [
        ...
        Divider(height: 1, indent: 8, endIndent: 8, color: isDark ? Colors.white.withValues(alpha: 0.08) : Colors.black.withValues(alpha: 0.06)),
        const SizedBox(height: 14),
