...
import '../../../features/achievement/screens/achievement_screen.dart';
...
import '../../home/screens/daily_tab.dart';
import '../../leaderboard/screens/leaderboard_tab.dart';
          ...
          Card(
            child: ListView.separated(
              ...
              separatorBuilder: (context, index) =>
                  Divider(height: 1, indent: 72, endIndent: 16, color: Theme.of(context).brightness == Brightness.dark ? Colors.white.withValues(alpha: 0.08) : Colors.black.withValues(alpha: 0.05)),
              itemBuilder: (context, index) {
